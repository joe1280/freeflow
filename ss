...
function pre_install(){
    ...
    echo "请输入SS连接密码"
    read -p "(默认密码: feihongml):" shadowsockspwd
    [ -z "$shadowsockspwd" ] && shadowsockspwd="feihongml"
    echo
    echo "---------------------------"
...
function install_ss(){
    ...
    if [ -f /usr/bin/pip ]; then
        ...
        echo
        echo -e  "app下载地址：\033[1;32mhttp://oatlgihy2.bkt.clouddn.com/ssapp.apk\033[0m"
        echo
        exit 0
    else
        echo
